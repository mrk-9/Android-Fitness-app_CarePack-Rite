...
// */
//public class SettingKinship1Fragment extends BaseFragment implements LibPostListner {
//
...
//        new PostLibResponse(SettingKinship1Fragment.this, new ModelKinship(), getActivity(), hashMap, WebServicesConst.KINSHIP + "/" + prefs.get(MyPrefs.keys.ID), WebServicesConst.RES.GET_KINSHIP, true, true);
//    }
//
...
//            new PostLibResponse(SettingKinship1Fragment.this, new ModelKinship(), getActivity(), hashMap, WebServicesConst.KINSHIP, WebServicesConst.RES.UPDATE_KINSHIP, true, true);
//        }
//    }
//
...
//                int Status = modelKinship.status;
//                if (Status == 200) {
//                    if (modelKinship.kinship != null && modelKinship.kinship.size() > 0)
//                        setData(modelKinship.kinship.get(0));
//                } else {
//                    toast(modelKinship.message.toString());
//                }
//            }
