...
public class TouchImageView extends ImageView {
    ...
    /**
     * Set zoom to the specified scale. Image will be centered around the point (focusX, focusY). These floats range from 0 to 1 and denote the focus point as a fraction from the left and top of the
     * view. For example, the top left corner of the image would be (0, 0). And the bottom right corner would be (1, 1).
     *
     * @param scale
     * @param focusX
     * @param focusY
    ...
    /**
     * Return the point at the center of the zoomed image. The PointF coordinates range in value between 0 and 1 and the focus point is denoted as a fraction from the left and top of the view. For
     * example, the top left corner of the image would be (0, 0). And the bottom right corner would be (1, 1).
     *
    ...
    /**
     * When transitioning from zooming from focus to zoom from center (or vice versa) the image can become unaligned within the view. This is apparent when zooming quickly. When the content size is
     * less than the view size, the content will often be centered incorrectly within the view. fixScaleTrans first calls fixTrans() and then makes sure the image is centered correctly within the
     * view.
     */
    ...
    /**
     * If the normalizedScale is equal to 1, then the image is made to fit the screen. Otherwise, it is made to fit the screen according to the dimensions of the previous image matrix. This allows the
     * image to maintain its zoom after rotation.
     */
    ...
    /**
     * Fling launches sequential runnables which apply the fling graphic to the image. The values for the translation are interpolated by the Scroller.
     *
     * @author Ortiz
     */
