...
public class ProgressWheel extends View {
    ...
    private void setupPaints() {
        ...
        textPaint1.setStyle(Style.FILL);
    ...
    private void parseAttributes(TypedArray a) {
        ...
        textSize1 = (int) a.getDimension(R.styleable.ProgressWheel_textSize,
                textSize1);
        textSize2 = (int) a.getDimension(R.styleable.ProgressWheel_textSize2,
                textSize2);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < splitText.length; i++) {
            ...
            if (i % 2 == 0) {
                float textHeight1 = textPaint1.descent() - textPaint1.ascent();
                float verticalTextOffset1 = (textHeight1 / 2) - textPaint1.descent();
                float horizontalTextOffset1 = textPaint1.measureText(s) / 2;
                float verticalTextOffsets1 = verticalTextOffset1 +verticalTextOffset1 - textHeight1 ;
                Log.d("TAG", "Progress WHeel 1  " + horizontalTextOffset1 + "    " + verticalTextOffset1);
                canvas.drawText(s, this.getWidth() / 2 - horizontalTextOffset1, this.getHeight() / 2 + verticalTextOffsets1, textPaint1);
            } else {
                float textHeight2 = textPaint2.descent() - textPaint2.ascent();
                float verticalTextOffset2 = (textHeight2 / 2) - textPaint2.descent();
                float horizontalTextOffset2 = textPaint2.measureText(s) / 2;
                float verticalTextOffsets2 = verticalTextOffset2 + verticalTextOffset2;
                Log.d("TAG", "Progress WHeel 2  " + horizontalTextOffset2 + "    " + verticalTextOffset2);
                canvas.drawText(s, this.getWidth() / 2 - horizontalTextOffset2-10, this.getHeight() / 2 + verticalTextOffsets2, textPaint2);
            }
        }
//        for (String s : splitText) {
//            float horizontalTextOffset = textPaint.measureText(s) / 2;
//            Log.d("TAG","Progress WHeel   "+horizontalTextOffset+"    "+verticalTextOffset);
...
//        setText(Math.round(((float) progress / 360) * 100) + "%");
    ...
    public void setTextSize2(int textSize) {
